...
function set_section_to_active(t, e, i, a) {
    if (void 0 !== t && "" != t) {
        ...
        if ("" != s && 0 != s.length)s.addClass("active"); else {
            var o = t.substr(1);
...
function fixed_bg_image_dimensions_on_mobile() {
    ...
    if (t.length > 0) {
        ...
        if (void 0 !== e && "" != e)if (jQuery.browser.mobile)$("body").css({"background-image": "", "background-position": "", "background-repeat": "", "background-size": "", "background-attachment": "", background: "#000"}), t.css({opacity: "1"}); else {
